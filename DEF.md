...
* A1 [FMAT] formatter
* A2 [LCUT] lCount
* A3 [RiSK] rSpace\_siller

### (E*) Exceptions #
* E0 [PASE] ZText\_Error
...
#### Function: #
WS.formatter
( fname, fout = None, space\_count = 2, *kargs, special = 0, 
  EXCEPTION = False )
...
space\_count -- This is the number of space/tab used for an 
...
### (E*) Exceptions #
- - -
* E0 [PASE] ZText\_Error ( Exception )

Exception:
class WS.ZText\_Error
( Exception )
...
- - -
* E1 [FMAT] UnbalancedBraces ( ZText\_Error )
